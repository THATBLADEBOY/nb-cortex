...
A local-first knowledge management tool for desktop, mobile, and web. Combines the structured data capabilities of Notion with the linked, file-based philosophy of Obsidian — powered by LLM intelligence. All data lives on your device first, with optional premium cloud sync and AI services.

Built on a **Tauri v2 + React** stack with opinionated patterns for both human developers and AI coding agents.
